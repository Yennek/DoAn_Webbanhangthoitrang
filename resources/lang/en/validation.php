...
return [
    ...
    */
    ...
    'alpha' => 'Giá trị phải là ch.',
    'alpha_dash' => 'Chỉ được phép: chữ, số, gạch ngang, gạch dưới',
    ...
    'boolean' => 'Không hợp lệ vui lòng thử .',
    'confirmed' => ':attribute confirmation không khớp nhau.',
    ...
    'ends_with' => 'Phải kết thúc  :values',
    ...
    'gt' => [
        ...
        'string' => 'Độ dài phải lơn hơn :value ký tự.',
        'array' => 'Giá trị phải lớn hơn :value ký tự.',
    ],
    'gte' => [
        'numeric' => 'Giá trị phải lớn hơn hoặc bằng :value.',
        'file' => 'Kích thước tệp phải lớn hơn hoặc bằng :value kilobytes.',
        'string' => 'Độ dài chuỗi phải lớn hơn hoặc  :value ký tự.',
        'array' => 'Giá trị phải lớn hơn hoặc bằng :value.',
    ],
    ...
    'starts_with' => 'Phải bắt đầu trong :values',
